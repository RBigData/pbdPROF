...
The package includes some default plots which can easily be produced, either by \code{plot()} or \code{autoplot()} calls.  Figure~\ref{fig:fpmpi} shows the plots which can be produced.
