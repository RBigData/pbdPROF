...
{\color{red}Problem:1.}If you have downloaded the package from github and tried to using R CMD INSTALL \pkg{pbdPROF} and you see an error similar to this
\begin{Output}
...
{\color{red}Problem:2.}If you are using \pkg{fpmpi}~\citep{fpmpi} externally and during it's installation you get an error similar to this
\begin{Output}
...
{\color{red}Problem:1.}While Running \pkg{Rmpi} code for profiling and  you encounter the below error:
\begin{Output}
...
{\color{red}Problem:2.}While Running \pkg{Rmpi} code for profiling and  you are encountering the below error:
\begin{Output}
