/* src/fpmpi/fpmpiconf.h.  Generated from fpmpiconf.h.in by configure.  */
...
#define SIZEOF_MPI_STATUS 0

/* Define the size of MPI_Status in ints */
#define SIZEOF_MPI_STATUS_IN_INTS 0
